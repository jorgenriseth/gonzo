rule T1w_signal_intensity_increase:
  input:
    ...
    mask="mri_processed_data/{subject}/segmentations/{subject}_mask-intracranial.nii.gz",
  output:
...
rule normalize_T1w:
    input:
        ...
        refroi="mri_processed_data/{subject}/segmentations/{subject}_refroi-left-orbital.nii.gz",
    output:
